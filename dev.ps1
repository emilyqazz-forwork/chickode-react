...
Write-Host "Starting Web on http://$HostAddress`:$WebPort"
Write-Host ""
...
Start-Process -FilePath "python" -ArgumentList @("-m","http.server",$WebPort,"--bind",$HostAddress) -WindowStyle Normal

Write-Host ""
Write-Host "Open: http://$HostAddress`:$WebPort/index.html"
